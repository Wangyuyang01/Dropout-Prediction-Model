'''
import numpy as np
from DataLoader.LoadKwaiData import getDataLoader as KwGetDataLoader
from DataLoader.LoadKDDData import getDataLoader as KddGetDataLoader
from DataLoader.LoadBaiduData import getDataLoader as BaiduGetDataLoader
import torch
from Model.CFIN import CFIN
from Model.MLP import MLP
from Model.RNN import RNN
from Model.CLSA import CLSA
from Model.FLTADP import FLTADP
...
def main():
    ...
    # file open
    f = open("./Log/" + str(params.seed) + "_" + str(
    ...
    if params.DataSet == 'Kwai':
        ...
        train_set, valid_set, test_set, day_numpy, model_param = KwGetDataLoader(params.batch_size, param)
        ...
        train_set, valid_set, test_set, day_numpy, model_param = BaiduGetDataLoader(params.batch_size, param)
...
def main():
    ...
    # Model
    parser.add_argument('--model_name', type=str, default='FLTADP')
